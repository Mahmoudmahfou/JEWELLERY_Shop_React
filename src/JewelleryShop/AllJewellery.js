...
import Itemsection from "../AllHome/Itemsection";
...
function Page() {
  ...
  const products = [
    {
      "id": 1,
      "title": "Ruby 14kt Gold Plated Spinner Ring For Women",
      "price": 109.95,
      ...
      {
      "id": 2,
      "title": "Personalized Engraved Handwriting Ring",
      "price": 22.3,
      ...
      {
      "id": 3,
      "title": "Shiny and beautiful 24 karat gold earring",
      "price": 55.99,
            ...
            {products.map((item) => (
              <div className="box" key={item.id}>
                ...
                <div className="detail-box">
                  ...
                  <a style={{cursor:"pointer"}} onClick={() => addItem(item)}>Add to cart</a>
                </div>
              </div>
            ))}
          </div>
